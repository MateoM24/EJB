...
insert into PRODUCT(ID, NAME, CATEGORY_ID, STOCK, VERSION) values (2000, 'Dell Optiplex 3010', 1002, 3, 1);
insert into PRODUCT(ID, NAME, CATEGORY_ID, STOCK, VERSION) values (2001, 'Dell Optiplex 3020', 1002, 5, 1);
insert into PRODUCT(ID, NAME, CATEGORY_ID, STOCK, VERSION) values (2002, 'Dell XPS', 1003, 10, 1);
insert into PRODUCT(ID, NAME, CATEGORY_ID, STOCK, VERSION) values (2003, 'Dell Latitude', 1003, 1, 1);
insert into PRODUCT(ID, NAME, CATEGORY_ID, STOCK, VERSION) values (2004, 'MS Windows 8', 1006, 2, 1);
insert into PRODUCT(ID, NAME, CATEGORY_ID, STOCK, VERSION) values (2005, 'MS Windows 10', 1006, 0, 1);
insert into PRODUCT(ID, NAME, CATEGORY_ID, STOCK, VERSION) values (2006, 'MS Office 2015', 1007, 4, 1);
